...
export function ShellSidebar() {
	return (
		<aside
			className="fixed bottom-0 left-0 top-16 z-30 hidden w-64 flex-col overflow-hidden border-r border-border-subtle bg-surface shadow-[1px_0_12px_rgba(0,0,0,0.35)] lg:flex"
